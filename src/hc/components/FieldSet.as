 ...
 * @default 12
 */
[Style(name="legendFontSize", type="Number", inherit="no")]

[Style(name="legendFontFamily", type="String", inherit="no")]

[Style(name="legendFontColor", type="uint", format="Color", inherit="no")]
